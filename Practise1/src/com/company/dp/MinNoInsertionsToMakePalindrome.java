...
public class MinNoInsertionsToMakePalindrome {
    public static void main(String[] args){
        ...
        System.out.println("Min no of insertions to make the given string palindrome = " + (N - lcs));

        int lcs1 = tabulation(N,M,s1,s2,dp);
        System.out.println("Min no of insertions to make the given string palindrome = " + (N - lcs1));

        int lcs2 = spaceOpt(N,M,s1,s2);
        System.out.println("Min no of insertions to make the given string palindrome = " + (N - lcs2));
    }
