...
public class LongestCommonPalindromicSubsequence {
    public static void main(String[] args){
        ...
        System.out.println("length of the longest common palindromic subsequence = " + lcs);

        int lcs1 = tabulation(N,M,s1,s2,dp);
        System.out.println(" length of the longest common palindromic subseequence = " + lcs1);

        int lcs2 = spaceOpt(N,M,s1,s2);
        System.out.println(" length of the longest common palindromic subseequence = " + lcs2);
    }
