...
public class MinimumNoOfInsertionsAndDeletionsToMakeAstr1Tostr2 {
    public static void main(String[] args){
        ...
        System.out.println("minimum no of insertions and deletions = " + ( N + M - 2*lcs));

        int lcs1 = tabulation(N,M,s1,s2,dp);
        System.out.println("minimum no of insertions and deletions = " + ( N + M - 2*lcs1));

        int lcs2 = spaceOpt(N,M,s1,s2);
        System.out.println("minimum no of insertions and deletions = " + ( N + M - 2*lcs2));
    }
